...
ELSE ( CPPUNIT_FOUND )
  MESSAGE( ERROR )
  MESSAGE("-- Looking for Cppunit in ${CPPUNIT_INSTALL}/include/cppunit/ - not found")
  MESSAGE("-- You will not be able to build tests. To build tests, first set the path where cppunit can be found.")
ENDIF ( CPPUNIT_FOUND )

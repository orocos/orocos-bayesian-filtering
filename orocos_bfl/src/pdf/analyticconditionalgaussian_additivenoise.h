...
#define __ANALYTIC_CONDITIONAL_GAUSSIAN_ADDITIVE_NOISE__
...
namespace BFL
{
  ...
  */
  class AnalyticConditionalGaussianAdditiveNoise : public AnalyticConditionalGaussian
    {
    public:
      /// Constructor
      /**
...
#endif // __ANALYTIC_CONDITIONAL_GAUSSIAN_ADDITIVE_NOISE__

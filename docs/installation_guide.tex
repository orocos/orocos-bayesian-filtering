...
The first Section~\ref{subsec:ubuntu} explains the most easy way of installation, which is through the use of precompiled Ubuntu/Debian packages.
...
\item Run CMake:
	...
	\item Press OK. CMake will shut down now, and BFL is ready to build. (If you get unexpected errors check the common problems section).
	\end{itemize}

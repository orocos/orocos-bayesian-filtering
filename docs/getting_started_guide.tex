...
\paragraph{Remark:} The code \begin{verbatim}
Sample<ColumnVector> noise; \end{verbatim} causes an allocation every time SampleFrom is called and therefore breaks realtime execution. For realtime use noise should be allocated during construction.
